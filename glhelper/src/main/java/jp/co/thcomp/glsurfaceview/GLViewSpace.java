...
import jp.co.thcomp.util.GLUtil;
...
public class GLViewSpace {
    ...
    public void setViewportSize(int projectionType, int x, int y, int width, int height, float zNear, float zFar) {
        mZNearWR = zNear;
        mZFarWR = zFar;

        setViewportSize(projectionType, x, y, width, height);
    }

    public void setViewportSize(int projectionType, int x, int y, int width, int height) {
        mXposVP = x;
        mYposVP = y;
        mWidthVP = width;
        mHeightVP = height;
        ...
        switch (projectionType) {
            case GLConstant.ProjectionType.ORTHOGRAPHIC:
                GLES10.glOrthof(mLeftWR, mRightWR, mBottomWR, mTopWR, mZNearWR, mZFarWR);
                break;
            case GLConstant.ProjectionType.PERSPECTIVE:
                GLES10.glFrustumf(mLeftWR, mRightWR, mBottomWR, mTopWR, mZNearWR, mZFarWR);
                break;
        }
    ...
    public void setViewPoint() {
        ...
        GLES10.glLoadIdentity();
        GLUtil.gluLookAt(mEyeX, mEyeY, mEyeZ, mCenterX, mCenterY, mCenterZ, mUpX, mUpY, mUpZ);
        mViewPoint = true;
    }

    public void setViewPoint(float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ) {
        mEyeX = eyeX;
        mEyeY = eyeY;
        mEyeZ = eyeZ;
        mCenterX = centerX;
        ...
        mUpY = upY;
        mUpZ = upZ;
        GLUtil.gluLookAt(eyeX, eyeY, eyeZ, centerX, centerY, centerZ, upX, upY, upZ);
        mViewPoint = true;
    }
